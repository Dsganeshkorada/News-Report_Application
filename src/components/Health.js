...
function Health({setCategeory,setShowForm,setIsEditing,setFormData,categeory,isEditing,formData,showForm}) {
  const handleAddForm = () => {
    setFormData({
      title: "",
      urlToImage: "",
  ...
  return (
    <>
      {showForm ? (
        ...
        <>
          <DataRetriving handleUpdate={handleUpdate}  categeory="health" setCategeory={setCategeory}/>
          <button
